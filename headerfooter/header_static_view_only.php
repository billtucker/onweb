 ...
 * Time: 2:39 PM
 *
 * This header will address OnSpot view only and will display a blank nav bar to reduce any user confusion
 */
    ...
    <div class="row tdc-nav-bar-background-grad">
        ...
        <form role="form" action="../commonutilities/printPage.php" method="post" id="print" name="print">
            ...
            <div class="col-xs-4 col-md-4">
                <!-- No Nav bar is not included when view only is turned on for OnSpot video review -->
            </div>
        </form>
