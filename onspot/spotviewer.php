...
<input id="disableNotes" type="hidden" value="<?php echo $disableNotes; ?>">
<input id="disableApproval" type="hidden" value="<?php echo $disableApproval; ?>">
<div class="row">
    <div class="col-md-9 col-xs-12"><!-- start video and project details column -->
        <?php
        if ($validVideo) {
            ?>
